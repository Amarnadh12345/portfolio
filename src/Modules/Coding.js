      ...
      >
        ...
        <div className="content-box">
          <div className="stat-card">
            <a href="https://leetcode.com/u/Amarnadhjasti/" target="new">
          ...
          <div className="stat-card">
            <a
              href="https://www.geeksforgeeks.org/user/amarnadhjasti123/"
              target="new"
            >
              <div className="stat-box">
                <img
          ...
          <div className="stat-card">
            <a href="https://www.hackerrank.com/profile/20MH1A0424" target="new">
              <div className="stat-box">
                <img
                  className="stat-logo"
                  src={hacker}
                ...
                <span className="link">
                  <a
                    href="https://www.hackerrank.com/profile/20MH1A0424"
                    target="new"
                  >
                    <BsBoxArrowUpRight />
                  </a>
